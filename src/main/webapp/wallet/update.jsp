                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<c:out value="${wallet.name}"/>" required>
                        </div>
                        <div class="mb-3">
                            <label for="amount" class="form-label">Số Tiền:</label>
                            <input type="text" class="form-control" id="amount" name="amount" value="<c:out value="${wallet.amount}"/>" required>
                        </div>
                    </div>
