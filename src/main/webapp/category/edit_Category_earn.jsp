...
<div class="container content">
    ...
    <form method="post">
        <input type="hidden" name="id" value="${category_earn.id}"/>

        <div class="mb-3">
            <label for="name" class="form-label">Tên danh mục:</label>
            <input type="text" id="name" name="name" value="${category_earn.name}" class="form-control" required/>
        </div>

        <div class="mb-3">
            <label for="note" class="form-label">Ghi chú:</label>
            <textarea id="note" name="note" class="form-control" required>${category_earn.note}</textarea>
        </div>
